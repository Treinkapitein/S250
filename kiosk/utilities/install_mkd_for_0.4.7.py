...
def main():
    ...
    os.system("mkdir /home/mm/kiosk/var/mkd.sys")
    doscp(22,"update",hostname,"~/kiosk/mkd2.sys/*","/home/mm/kiosk/var/mkd.sys","get")
    os.system("mkdir /home/mm/kiosk/var/mkd.data")
    doscp(22,"update",hostname,"~/crontabs/mm","/home/mm/kiosk/tmp","get")
    os.system('echo howcute121 | sudo -S cp -f /home/mm/kiosk/tmp/mm /var/spool/cron/crontabs/')
    os.system('echo howcute121 | sudo -S chown mm.mm /var/spool/cron/crontabs/mm')
    doscp(22,"update",hostname,"~/ifplugd.action","/home/mm/kiosk/tmp","get")
    os.system('echo howcute121 | sudo -S cp -f /home/mm/kiosk/tmp/ifplugd.action /usr/local/etc/ifplugd/')
    os.system('echo howcute121 | sudo -S chmod 755 /usr/local/etc/ifplugd/ifplugd.action')
    os.system('/usr/bin/gconftool-2  --type string --set  /desktop/gnome/background/picture_filename  "/home/mm/kiosk/var/gui/sys/bg_outofservice.png"')
