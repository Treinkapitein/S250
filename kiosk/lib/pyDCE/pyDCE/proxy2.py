...
class RemoteMethod:
    ...
    def __call__(self, *args, **kwargs):
      ...
      #  return self.__send(self.__name, args, kwargs)
        return self._proxy.dce_invoke(self._obj,self._method,self._one_way,self._compress,self._ctx,self._timeout,self._async,args,kwargs)
...
#(request_uuid,reply status,body)
    ...
    def __getattr__(self,dce_method_name,dce_one_way=0,dce_compress=0,dce_ctx={},dce_timeout=0,dce_async=0):
        print "__getattr__",dce_method_name
